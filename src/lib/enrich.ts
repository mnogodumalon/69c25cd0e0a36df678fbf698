import type { EnrichedPicknickPlanung, EnrichedRezepte, EnrichedVereinsversammlungen } from '@/types/enriched';
import type { Mitgliederverwaltung, PicknickPlanung, Rezepte, Vereinsversammlungen, Zutaten } from '@/types/app';

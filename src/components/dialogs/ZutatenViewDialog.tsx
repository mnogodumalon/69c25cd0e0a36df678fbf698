      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          <div className="space-y-1">
            <Label className="text-xs text-muted-foreground">Zutatenname</Label>
            <p className="text-sm">{record.fields.zutaten_name ?? '—'}</p>
          </div>
          <div className="space-y-1">
          ...
          <div className="space-y-1">
            <Label className="text-xs text-muted-foreground">Maßeinheit</Label>
            <p className="text-sm">{record.fields.masseinheit ?? '—'}</p>
          </div>
          <div className="space-y-1">

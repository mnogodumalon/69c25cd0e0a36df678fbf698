...
interface MitgliederverwaltungDialogProps {
  ...
  defaultValues?: Mitgliederverwaltung['fields'];
  enablePhotoScan?: boolean;
  enablePhotoLocation?: boolean;
}

export function MitgliederverwaltungDialog({ open, onClose, onSubmit, defaultValues, enablePhotoScan = false, enablePhotoLocation = true }: MitgliederverwaltungDialogProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      const clean = cleanFieldsForApi({ ...fields }, 'mitgliederverwaltung');
  ...
  const DIALOG_INTENT = defaultValues ? 'Mitgliederverwaltung bearbeiten' : 'Mitgliederverwaltung hinzufügen';
      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="jahresbeitrag_status">Jahresbeitrag bezahlt am</Label>
            <Input
              id="jahresbeitrag_status"
              type="date"
              value={fields.jahresbeitrag_status ?? ''}
              onChange={e => setFields(f => ({ ...f, jahresbeitrag_status: e.target.value }))}
            />
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Select
              value={lookupKey(fields.mitgliedsstatus) ?? 'none'}
              onValueChange={v => setFields(f => ({ ...f, mitgliedsstatus: v === 'none' ? undefined : v as any }))}
            >
              <SelectTrigger id="mitgliedsstatus"><SelectValue placeholder="Auswählen..." /></SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-2">
            <Label htmlFor="abteilung">Abteilung im Verein</Label>
            <Input
              id="abteilung"

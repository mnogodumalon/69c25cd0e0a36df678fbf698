...
const navigation = [
  ...
  { name: 'Features', href: '/features', icon: IconFileText },
  { name: 'Testergebnisse', href: '/testergebnisse', icon: IconFileText },
  { name: 'Fehlerberichte', href: '/fehlerberichte', icon: IconFileText },
];
...
const externalNavigation = [
  ...
  { name: 'Features', href: '/gateway/apps/69c2a885ef5542af1ff3e803?template=list_page', icon: IconFileText },
  { name: 'Testergebnisse', href: '/gateway/apps/69c2a88646e6d003d7275863?template=list_page', icon: IconFileText },
  { name: 'Fehlerberichte', href: '/gateway/apps/69c2a887234dbbd08df29869?template=list_page', icon: IconFileText },
];

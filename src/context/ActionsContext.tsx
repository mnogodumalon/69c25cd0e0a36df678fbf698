...
export function ActionsProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <ActionsContext.Provider
      value={{ actions, chatOpen, setChatOpen, messages, chatLoading, runAction, sendMessage, devMode, setDevMode, showActionCode, deleteAction: deleteActionFn, inputFormAction, submitActionInputs, cancelInputForm }}
    >
      {children}
    </ActionsContext.Provider>
  );
